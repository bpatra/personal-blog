...
comments:
- id: 21168
  author: Leandro Guimar&atilde;es
  author_email: leocgpe@gmail.com
  author_url: ''
  date: '2017-03-06 18:52:55 +0000'
  date_gmt: '2017-03-06 18:52:55 +0000'
  content: "Hello, MigrateDatabaseToLatestVersion has been enough to update your clients'
    database?\r\nIs it really safe?\r\nPeople advise me to do the automated migration
    in some other way.\r\nPlease, can you tell us a bit about this point?\r\nI also
    want to scale my application to provide multiple clients, but I do not even know
    where to start. At the moment I'm just reading about azure resources scripts."
- id: 21170
  author: Benoit Patra
  author_email: benoit.patra@gmail.com
  author_url: https://www.benoitpatra.com
  date: '2017-03-06 20:03:47 +0000'
  date_gmt: '2017-03-06 20:03:47 +0000'
  content: "Hi Leandro,\r\n<blockquote>MigrateDatabaseToLatestVersion has been enough
    to update your clients&rsquo; database?</blockquote>\r\n<code>MigrateDatabaseToLatestVersion</code>
    plus a clean history of migration generated has explained in the post were enough
    for updating the clients databases.\r\n\r\n<blockquote>Is it really safe? People
    advise me to do the automated migration in some other way.</blockquote>\r\nCan
    you be more precise. What do you mean by safe? What is the potential problem?
    What are the arguments of people against <code>MigrateDatabaseToLatestVersion</code>?
    \r\n\r\nDo not confuse <code>MigrateDatabaseToLatestVersion</code> with a <code>AutomatedMigration</code>
    which I believe risky. As explain in the post, I believe <code>Automated Migrations</code>
    risky because migrations are generated automatically behind your back and applied
    directly. <code>MigrateDatabaseToLatestVersion</code> is different if invoked
    at startup of application it will just apply pending migrations but does not generate
    any SQL code on your back."
- id: 22035
  author: Andre Lourenco
  author_email: andrefigueiralourenco@gmail.com
  author_url: ''
  date: '2017-04-24 22:45:05 +0000'
  date_gmt: '2017-04-24 22:45:05 +0000'
  content: "Hi Benoit,\r\n\r\nHow does the MigrateDatabaseToLatestVersion behave on
    a High Availability Environment, where there are multiple Application Servers
    \ that access the same Database?\r\n\r\nIf two or more Application Servers are
    started at the same time, wouldn't the Migration fail since it's being executed
    by two servers at the same time? \r\n\r\nOr is the MigrateDatabaseToLatestVersion
    ready for that kind of scenario?"
- id: 22037
  author: Benoit Patra
  author_email: benoit.patra@gmail.com
  author_url: https://www.benoitpatra.com
  date: '2017-04-25 07:08:08 +0000'
  date_gmt: '2017-04-25 07:08:08 +0000'
  content: That is an excellent question. Intuitively I would say that migrations
    would be protected against race conditions with a transaction mechanism but I
    am not sure. This would be a good stackoverflow question if not documented yet
    by Microsoft.
---
